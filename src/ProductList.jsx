...
function ProductList() {
    ...
    const categoryList = plantsArray.map((element) => {

        const plantList = element.plants.map((plant) => {
            const isInCart = cartItems.some((cartItem) => cartItem.name === plant.name); // Check if plant is in cart

            return (
                <li key={plant.name} className={plant.name}>
                    <div className="product-card">
                        ...
                        <button
                            className={`product-button ${isInCart ? 'disabled-button' : ''}`} // Conditionally apply the class
        ...
        return (
            <div key={element.category}>
                <div className="plant_heading">
                    <p className="plantname_heading">{element.category}</p>
                </div>
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div> <a href="#" onClick={(e) => handlePlantsOnClick(e)} style={styleA}>Plants</a></div>
                    <div>
